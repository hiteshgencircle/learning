  ...
  <div class="container">
    ...
    <div class="pb-tabs-outer">
      <ul class="pb-tabs" id="pb-tabs" role="tablist">
        <li><button class="pb-tab-btn active" data-cat="all">All <span class="pb-pill" id="pill-all"></span></button></li>
        @if($categories)
          @foreach($categories as $cat)

            <li><button class="pb-tab-btn" data-cat="{{$cat->slug}} ">{{$cat->name}} <span class="pb-pill">{{$cat->count}}</span></button></li>
          @endforeach
        @endif
    ...
    <div class="pb-pagination" id="pb-pagination">
      ...
      <div class="pb-pag-btns" id="pb-pag-btns"></div>
    </div>
